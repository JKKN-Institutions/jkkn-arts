                    ...
                    <div className="cta-content">
                      <h2 className="title text-anim">
                        ...
                        <span className="cta-img wow fadeInUp" data-wow-delay=".3s">
                          <Image src="/assets/images/img/Campus-Life.png" alt="" width={400} height={300} style={{ width: "100%", height: "auto" }} />
                    ...
                    <div className="h9-about-area">
                      <div className="about-img-area h9-about-img wow fadeInLeft" data-wow-delay=".3s">
                        <div className="about-img overflow-hidden">
                          <Image src="/assets/images/img/outside-compus.png" alt="" width={400} height={300} style={{ width: "100%", height: "auto" }} data-speed=".8"   />
                        </div>
