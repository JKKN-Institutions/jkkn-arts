                ...
                <div className="row flex-column-reverse flex-lg-row">
                  ...
                  <div className="col-lg-8 col-xl-9">
                    <div className="banner-content-2">
                      <h1 className="banner-title text-anim">Department of Commerce <i className="fas fa-arrow-trend-up wow fadeInRight" data-wow-delay=".7s"></i>
                      </h1>
                          ...
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              ...
                              <ul className="list-items">
                                <li><i className="fas fa-check"></i>B.Com - 3 Years</li>
                                <li><i className="fas fa-check"></i>M.Com - 2 Years</li>
