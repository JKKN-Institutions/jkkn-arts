              ...
              <div className="banner-area">
                ...
                <div className="banner-right-box">
                  <div className="banner-img">
                    <Image src="/assets/images/img/bba-1.png" alt="" width={400} height={300} style={{ width: "100%", height: "auto" }} data-speed="0.8"   />
                  </div>
                  ...
                  <div className="col-lg-6 order-lg-2">
                    <div className="testimonial-img-area wow fadeInUp" data-wow-delay=".3s">
                      <div className="testimonial-img">
                        <Image src="/assets/images/img/bba-2.png" alt="Career Opportunities" width={400} height={300} style={{ width: "100%", height: "auto" }} />
