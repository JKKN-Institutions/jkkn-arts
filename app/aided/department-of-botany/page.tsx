...
export default function DepartmentOfBotany() {
  return (
    <PageLayout>
                  ...
                  <div className="col-lg-4 col-xl-3">
                    <div className="h10-hero-award-wrapper">
                      <div className="h6-hero-history wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <p className="h6-hero-history-desc">Botany offered as an Allied subject for B.Sc. Zoology with focus on plant biology, ecology, and conservation.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-8 col-xl-9">
                    <div className="banner-content-2">
                      <h1 className="banner-title text-anim">Department of Botany <i className="fas fa-curve-arrow wow fadeInRight" data-wow-delay=".7s"></i>
                      </h1>
                      <div className="banner-desc-area wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div className="banner-desc">Comprehensive curriculum equipping students with strong foundations in plant biology, ecology, and conservation.
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="sec-heading-wrap style-8">
                      <div className="heading-wrap-content">
                        <div className="sec-heading style-3">
                          ...
                          <h2 className="sec-title text-anim">Comprehensive Botany Curriculum.</h2>
                        </div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".1s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-botany">Plant Anatomy & Morphology</a></h4>
                                <p className="desc">Structure and development of plants including cells, tissues, organs, and their functions.
                                </p>
                                <a className="text-btn" href="/department-of-botany">
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".3s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-botany">Plant Physiology</a></h4>
                                <p className="desc">Functional processes in plants including photosynthesis, respiration, growth, and metabolism.
                                </p>
                                <a className="text-btn" href="/department-of-botany">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".7s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-botany">Ecology & Biodiversity</a></h4>
                                <p className="desc">Ecosystems, plant communities, biodiversity conservation, and environmental sustainability.
                                </p>
                                <a className="text-btn" href="/department-of-botany">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".5s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-botany">Conservation & Biotechnology</a></h4>
                                <p className="desc">Plant conservation strategies, micropropagation, and applications of plant biotechnology.
                                </p>
                                <a className="text-btn" href="/department-of-botany">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                ...
                <div className="row flex-column-reverse flex-md-row ">
                  ...
                  <div className="col-12 col-lg-7">
                    <div className="h10-about-content-wrapper">
                      <div className="sec-heading style-3 ">
                        <span className="sub-title wow fadeInUp" data-wow-delay=".3s"><i className="fas fa-box"></i> ABOUT BOTANY</span>
                        <h2 className="sec-title title-highlight wow fadeInUp" data-wow-delay=".3s">Strong foundations in plant biology, ecology and conservation.
                        </h2>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-lg-12">
                          <div className="h10-about-content">
                            ...
                            <p className="desc wow fadeInUp" data-wow-delay=".4s">The department was established in the year 1976. Botany is being offered as an Allied subject for B.Sc. Zoology. The Department of Botany offers a comprehensive curriculum designed to equip students with a deep understanding of plant biology, ecology, and conservation.</p>
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="sec-heading-wrap ">
                      ...
                      <h2 className="sec-title text-anim">Foundation for Success in Botany.</h2>
                        </div>
                        <div className="btn-area wow fadeInUp" data-wow-delay=".8s">
                          <a className="tj-primary-btn" href="#">
                            <span className="btn-text"><span>Apply Now</span></span>
                      ...
                      <div className="blog-item style-2 wow fadeInUp" data-wow-delay=".3s">
                        <div className="blog-content">
                          ...
                          <div className="title-area">
                            ...
                            <p>The Botany department equips students with a strong foundation in plant science and practical skills relevant to conservation, research, and allied biological sciences.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="row">
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              <p className="desc">To meet the ever expanding global needs by educating students in the world of flora</p>
                            </div>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              <p className="desc">To produce professionally competent and socially responsible graduates for the betterment of mankind and to sustain healthy environment</p>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="container">
                <div className="row h8-team-wrapper gap-0">
                  <div className="col-lg-3 col-sm-6">
                    <div className="sec-heading style-3">
                      <span className="sub-title wow fadeInUp" data-wow-delay=".3s">NAME OF THE FACULTY</span>
                      <h2 className="sec-title title-anim">Our Faculty.</h2>
                    </div>
                  </div>
                    ...
                    <div className="team-item wow fadeInRightBig" data-wow-delay=".2s">
                      <div className="team-img">
                        <div className="team-img-inner">
                          <Image src="/assets/images/team/botany-aided/Mr.-N.-Udhayakumar.png" alt="Mr. N. Udhayakumar" width={400} height={300} style={{ width: '100%', height: 'auto', objectFit: 'contain' }} />
                        </div>
                      ...
                      <div className="team-content">
                        <h5 className="title">Mr. N. Udhayakumar</h5>
                        <span className="designation">Assistant Professor & Head</span>
                        <p className="qualification">M.Sc., NET</p>
                        <div className="social-links">
                          <ul>
                            <li><a href="mailto:udhayakumar.n@jkkn.ac.in" target="_blank"><i className="fa-solid fa-envelope"></i></a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
