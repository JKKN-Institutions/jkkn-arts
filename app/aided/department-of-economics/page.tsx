                  ...
                  <div className="col-lg-4 col-xl-3">
                    <div className="h10-hero-award-wrapper">
                      <div className="h6-hero-history wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <p className="h6-hero-history-desc">Excellence in Economics Education since 1975, providing quality education and research in this backward region.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-8 col-xl-9">
                    <div className="banner-content-2">
                      <h1 className="banner-title text-anim">Department of Economics <i className="fas fa-curve-arrow wow fadeInRight" data-wow-delay=".7s"></i>
                      </h1>
                      <div className="banner-desc-area wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div className="banner-desc">Committed to providing quality education and research in Economics, igniting young minds for overall development in this region.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    <div className="h10-hero-banner zoom-on-scroll">
                      <div className="h10-hero-banner-img h10-hero-banner-video">
                        <video autoPlay loop muted playsInline data-wf-ignore="true" data-object-fit="cover" poster="/assets/images/img/department-of-economics.png">
                    ...
                    <div className="sec-heading-wrap style-8">
                      <div className="heading-wrap-content">
                        <div className="sec-heading style-3">
                          ...
                          <h2 className="sec-title text-anim">Comprehensive Economics Curriculum.</h2>
                        </div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".1s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><Link href="/#">Microeconomics</Link></h4>
                                <p className="desc">Study of individual economic behavior, market structures, and decision-making processes.
                                </p>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".3s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><Link href="/#">Macroeconomics</Link></h4>
                                <p className="desc">Study of national and global economic systems, policies, and aggregate economic behavior.
                                </p>
                                <Link className="text-btn" href="/#">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".7s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><Link href="/#">Development Economics</Link></h4>
                                <p className="desc">Study of economic development processes, poverty reduction, and sustainable growth strategies.
                                </p>
                                <Link className="text-btn" href="/#">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".5s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><Link href="/#">Economic Policy</Link></h4>
                                <p className="desc">Analysis of government policies, fiscal and monetary measures, and their economic impact.
                                </p>
                                <Link className="text-btn" href="/#">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                ...
                <div className="row flex-column-reverse flex-md-row ">
                  ...
                  <div className="col-12 col-lg-7">
                    <div className="h10-about-content-wrapper">
                      <div className="sec-heading style-3 ">
                        <span className="sub-title wow fadeInUp" data-wow-delay=".3s"><i className="fas fa-box"></i> ABOUT ECONOMICS</span>
                        <h2 className="sec-title title-highlight wow fadeInUp" data-wow-delay=".3s">Committed to Quality Education and Research in Economics.
                        </h2>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-lg-12">
                          <div className="h10-about-content">
                            ...
                            <p className="desc wow fadeInUp" data-wow-delay=".4s">The Department of Economics was established in the year 1975. The Management of J.K.K. Nataraja Arts & Science College was very keen to set up this Department in this college to cater to the needs of the students in this backward region.</p>
                            ...
                            <div className="h9-about-funfact h10-about-funfact">
                              ...
                              <div className="countup-item">
                                ...
                                <span className="count-text">Student satisfaction rate.</span>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className="row">
                  <div className="col-12 col-lg-5">
                    <div className="sec-heading style-3 tj-sticky-panel-3">
                      ...
                      <h2 className="sec-title text-anim">Comprehensive Economics Learning Experience.</h2>
                    ...
                    <div className="h10-process-wrapper">
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Comprehensive theoretical lectures provide students with the necessary foundational knowledge covering microeconomics, macroeconomics, development economics, and economic policy analysis.</p>
                        </div>
                      </div>
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Hands-on practical sessions allow students to gain experience in economic data analysis, case studies, and real-world economic problem-solving using modern analytical tools.</p>
                        </div>
                      </div>
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Research projects provide students with opportunities to apply their knowledge and skills to real-world economic problems and contribute to the advancement of economic understanding and policy development.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="sec-heading-wrap ">
                      <div className="heading-wrap-content">
                        <div className="sec-heading style-3">
                          ...
                          <h2 className="sec-title text-anim">Foundation for Success in Economics.</h2>
                        </div>
                        <div className="btn-area wow fadeInUp" data-wow-delay=".8s">
                          <Link className="tj-primary-btn" href="#">
                            <span className="btn-text"><span>Apply Now</span></span>
                        ...
                        <div className="blog-content">
                          <div className="blog-meta">
                            <div className="blog-date-wrapper">
                              <span className="blog-author">Allied Course</span>
                            </div>
                            <span className="categories">For Commerce & History</span>
                          </div>
                          <div className="title-area">
                            <h3 className="title">Career Foundation</h3>
                            <p>Overall, the Economics program provides students with a solid foundation in the principles and applications of economics, equipping them with the necessary knowledge and skills to understand economic systems, analyze market behavior, and contribute to policy development in various sectors.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="row">
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              <p className="desc">
                                To ignite the young minds in the direction of overall development.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              <p className="desc">To provide Quality Education, Research and Extension of Higher Education.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="team-item wow fadeInRightBig" data-wow-delay=".2s">
                      <div className="team-img">
                        <div className="team-img-inner">
                          <Image src="/assets/images/team/economics-aided/Dr.-B.-Suresh.png" alt="" width={400} height={300} style={{ width: "100%", height: "auto" }} />
                        </div>
                        <div className="social-links">
                          <ul>
                            <li><a href="mailto:suresh.b@jkkn.ac.in" target="_blank"><i className="fa-solid fa-envelope"></i></a></li>
                          </ul>
                        </div>
                      </div>
                      <div className="team-content">
                        <h5 className="title">Dr. B. Suresh</h5>
                        <span className="designation">Assistant Professor & Head</span>
                        <p className="qualification">M.A., Ph.D. (SET)</p>
                      </div>
                    </div>
                  </div>
                </div>
