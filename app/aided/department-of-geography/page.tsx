                  ...
                  <div className="col-lg-4 col-xl-3">
                    <div className="h10-hero-award-wrapper">
                      <div className="h6-hero-history wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <p className="h6-hero-history-desc">Excellence in Geography Education since 1974, imparting quality education in Geography and serving as an allied department of History.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-8 col-xl-9">
                    <div className="banner-content-2">
                      <h1 className="banner-title text-anim">Department of Geography <i className="fas fa-curve-arrow wow fadeInRight" data-wow-delay=".7s"></i>
                      </h1>
                      <div className="banner-desc-area wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div className="banner-desc">Premier centre for academic excellence in Geography, preparing students for successful careers in geographical sciences and research.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="col-12">
                    <div className="h10-hero-banner zoom-on-scroll">
                      <div className="h10-hero-banner-img h10-hero-banner-video">
                        <video autoPlay loop muted playsInline data-wf-ignore="true" data-object-fit="cover" poster="/assets/images/img/department-of-Geography.png">
                    ...
                    <div className="sec-heading-wrap style-8">
                      <div className="heading-wrap-content">
                        <div className="sec-heading style-3">
                          ...
                          <h2 className="sec-title text-anim">Comprehensive Geography Curriculum.</h2>
                        </div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".1s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-geography">Physical Geography</a></h4>
                                <p className="desc">Study of natural features and processes of the Earth including landforms, climate, and ecosystems.
                                </p>
                                <a className="text-btn" href="/department-of-geography">
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".3s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-geography">Human Geography</a></h4>
                                <p className="desc">Study of human activities, cultures, and their relationship with the environment.
                                </p>
                                <a className="text-btn" href="/department-of-geography">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".7s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-geography">Regional Geography</a></h4>
                                <p className="desc">Comprehensive study of specific regions, their characteristics, and development patterns.
                                </p>
                                <a className="text-btn" href="/department-of-geography">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".5s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-geography">Geographic Information Systems</a></h4>
                                <p className="desc">Modern mapping techniques, spatial analysis, and geographic data management.
                                </p>
                                <a className="text-btn" href="/department-of-geography">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                ...
                <div className="row flex-column-reverse flex-md-row ">
                  ...
                  <div className="col-12 col-lg-7">
                    <div className="h10-about-content-wrapper">
                      <div className="sec-heading style-3 ">
                        <span className="sub-title wow fadeInUp" data-wow-delay=".3s"><i className="fas fa-box"></i> ABOUT GEOGRAPHY</span>
                        <h2 className="sec-title title-highlight wow fadeInUp" data-wow-delay=".3s">Premier Centre for Academic Excellence in Geography.
                        </h2>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-lg-12">
                          <div className="h10-about-content">
                            ...
                            <p className="desc wow fadeInUp" data-wow-delay=".4s">Established in the year of 1974, the department of geography at J.K.K. Nataraja College of Arts and Science aims at imparting quality education in Geography.</p>
                            
                            <p className="desc wow fadeInUp" data-wow-delay=".5s">The department of Geography its allied department of History.</p>
                            ...
                            <div className="h9-about-funfact h10-about-funfact">
                              <div className="countup-item">
                                ...
                                <span className="count-text">Experienced faculty member.</span>
                              </div>
                              <div className="countup-item">
                                <div className="inline-content">
                                ...
                                <span className="count-text">Of academic excellence since 1974.</span>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className="row">
                  <div className="col-12 col-lg-5">
                    <div className="sec-heading style-3 tj-sticky-panel-3">
                      ...
                      <h2 className="sec-title text-anim">Comprehensive Geography Learning Experience.</h2>
                    ...
                    <div className="h10-process-wrapper">
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Comprehensive theoretical lectures provide students with the necessary foundational knowledge covering physical geography, human geography, and regional studies.</p>
                        </div>
                      </div>
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          <h4 className="title">Field Studies</h4>
                          <p className="desc">Hands-on field study sessions allow students to gain practical experience in geographical surveying, mapping, and environmental analysis using modern geographical tools and techniques.</p>
                        </div>
                      </div>
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Research projects provide students with opportunities to apply their knowledge and skills to real-world geographical problems and contribute to the advancement of geographical sciences and environmental understanding.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="sec-heading-wrap ">
                      <div className="heading-wrap-content">
                        <div className="sec-heading style-3">
                          ...
                          <h2 className="sec-title text-anim">Foundation for Success in Geography.</h2>
                        </div>
                        <div className="btn-area wow fadeInUp" data-wow-delay=".8s">
                          <a className="tj-primary-btn" href="#">
                            <span className="btn-text"><span>Apply Now</span></span>
                      ...
                      <div className="blog-item style-2 wow fadeInUp" data-wow-delay=".3s">
                        <div className="blog-content">
                          <div className="blog-meta">
                            ...
                            <span className="categories">Allied Department</span>
                          </div>
                          <div className="title-area">
                            <h3 className="title">Academic Excellence</h3>
                            <p>The Geography department provides students with a solid foundation in the principles and applications of geographical sciences, equipping them with the necessary knowledge and skills to pursue careers in research, academia, environmental management, or related geographical disciplines.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="row">
                        <div className="col-12 col-md-4 col-xl-4">
                          <div className="service-item h8-service-item">
                            ...
                            <h4 className="title">B.A., Geography</h4>
                            <div className="service-content">
                              <p className="desc">
                                <strong>Duration:</strong> 3 years<br/>
                                <strong>Level:</strong> Undergraduate<br/>
                                Comprehensive foundation in geographical sciences
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-12 col-md-4 col-xl-4">
                          <div className="service-item h8-service-item">
                            ...
                            <h4 className="title">M.A., Geography</h4>
                            <div className="service-content">
                              <p className="desc">
                                <strong>Duration:</strong> 2 years<br/>
                                <strong>Level:</strong> Postgraduate<br/>
                                Advanced study in specialized geographical fields
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-12 col-md-4 col-xl-4">
                          <div className="service-item h8-service-item">
                            ...
                            <h4 className="title">M.Phil., Geography</h4>
                            <div className="service-content">
                              <p className="desc">
                                <strong>Duration:</strong> 2 years<br/>
                                <strong>Level:</strong> Research<br/>
                      ...
                      <div className="row">
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              <p className="desc">
                                To evolve discipline and fuel the education of informed and responsible global citizens through innovative, engaged and relevant teaching.
                              </p>
                            </div>
                          </div>
                        </div>
                        <div className="col-12 col-md-6 col-xl-6">
                          <div className="service-item h8-service-item">
                            ...
                            <div className="service-content">
                              <p className="desc">To serve the community by disseminating geographic knowledge and by providing geographic insights on important social issues.</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="team-item wow fadeInRightBig" data-wow-delay=".2s">
                      <div className="team-img">
                        <div className="team-img-inner">
                          <Image src="/assets/images/team/geography-aided/Mr.-S.-Bharathi.png" alt="" width={400} height={300} style={{ width: "100%", height: "auto" }} />
                        </div>
                        <div className="social-links">
                          <ul>
                            <li><a href="mailto:bharathi.s@jkkn.ac.in" target="_blank"><i className="fa-solid fa-envelope"></i></a></li>
                          </ul>
                        </div>
                      </div>
                      <div className="team-content">
                        <h5 className="title">Mr. S. Bharathi</h5>
                        <span className="designation">Assistant Professor & Head</span>
                        <p className="qualification">M.Sc., M.Phil., B.Ed., M.A. (ENG)., PGDCA, SET</p>
                      </div>
                    </div>
                  </div>
                </div>
