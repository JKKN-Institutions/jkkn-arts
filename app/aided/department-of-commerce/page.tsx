                  ...
                  <div className="col-lg-4 col-xl-3">
                    <div className="h10-hero-award-wrapper">
                      <div className="h6-hero-history wow fadeInUp" data-wow-delay=".3s">
                        ...
                        <p className="h6-hero-history-desc">Excellence in Commerce Education with B.Com since 1976 and M.Com since 1982, fostering business leadership and financial expertise.</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-8 col-xl-9">
                    <div className="banner-content-2">
                      ...
                      <div className="banner-desc-area wow fadeInUp" data-wow-delay=".7s">
                        ...
                        <div className="banner-desc">Rich history of academic excellence in Commerce education, preparing students for the dynamic business landscape with comprehensive B.Com and M.Com programs.
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="swiper-wrapper">
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".1s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-commerce">Accounting & Finance</a></h4>
                                <p className="desc">Comprehensive study of financial accounting, management accounting, and corporate finance principles.
                                </p>
                                <a className="text-btn" href="/department-of-commerce">
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".3s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-commerce">Banking & Insurance</a></h4>
                                <p className="desc">In-depth study of banking operations, insurance principles, and financial risk management.
                                </p>
                                <a className="text-btn" href="/department-of-commerce">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".7s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-commerce">Taxation & Law</a></h4>
                                <p className="desc">Comprehensive study of tax laws, mercantile law, and regulatory compliance in business operations.
                                </p>
                                <a className="text-btn" href="/department-of-commerce">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                          ...
                          <div className="swiper-slide">
                            <div className="service-item style-4 wow fadeInUp" data-wow-delay=".5s">
                              ...
                              <div className="service-content">
                                <h4 className="title"><a href="/department-of-commerce">Marketing & Capital Markets</a></h4>
                                <p className="desc">Advanced study of marketing strategies, capital market operations, and investment analysis.
                                </p>
                                <a className="text-btn" href="/department-of-commerce">
                                  <span className="btn-text"><span>Learn More</span></span>
                                  <span className="btn-icon"><i className="fas fa-arrow-right-long"></i></span>
                  ...
                  <div className="col-12 col-lg-7">
                    <div className="h10-about-content-wrapper">
                      <div className="sec-heading style-3 ">
                        ...
                        <h2 className="sec-title title-highlight wow fadeInUp" data-wow-delay=".3s">Rich History of Academic Excellence in Commerce Education.
                        </h2>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-12 col-md-6 col-lg-12">
                          <div className="h10-about-content">
                            ...
                            <p className="desc wow fadeInUp" data-wow-delay=".4s">The Department of Commerce, established in 1976, has a rich history of academic excellence. Initially offering a B.Com degree program, the department upgraded to a postgraduate department in 1982, demonstrating its commitment to providing high-quality education. To foster intellectual growth, the department has organized national-level conferences and symposia, showcasing its dedication to academic enrichment.</p>
                            
                            <p className="desc wow fadeInUp" data-wow-delay=".5s">The faculty members have made significant contributions to the field, publishing 100 papers in renowned national and international journals, presenting 188 papers at national seminars and conferences, and serving as resource persons and chairpersons in various academic forums. Their expertise has also been sought after by Periyar University and other educational institutions, where they have played key roles in shaping academic curricula and policies.</p>
                            
                            <p className="desc wow fadeInUp" data-wow-delay=".6s">Besides, 2 textbooks have been authored from the department and Prestigious Awards viz. Social Activist Award, Best Teacher Award and PUTHUMAI PEN Award have also been received by a faculty member.</p>
                            ...
                            <div className="h9-about-funfact h10-about-funfact">
                              <div className="countup-item">
                                ...
                                <span className="count-text">Research papers published.</span>
                              </div>
                              <div className="countup-item">
                                <div className="inline-content">
                                ...
                                <span className="count-text">Papers presented at conferences.</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="h10-process-wrapper">
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Comprehensive theoretical lectures provide students with the necessary foundational knowledge covering accounting principles, banking operations, taxation laws, marketing strategies, and business management concepts.</p>
                        </div>
                      </div>
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Hands-on practical sessions allow students to gain experience in accounting software, financial analysis, business simulations, and case study analysis using modern business tools and technologies.</p>
                        </div>
                      </div>
                      <div className="h10-process-item tj-sticky-panel-3">
                        ...
                        <div className="h10-process-content">
                          ...
                          <p className="desc">Research projects provide students with opportunities to apply their knowledge and skills to real-world business problems and contribute to the advancement of commerce education and business practices.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="blog-item style-2 wow fadeInUp" data-wow-delay=".3s">
                        <div className="blog-content">
                          ...
                          <div className="title-area">
                            ...
                            <p>Overall, the B.Com and M.Com programs provide students with a solid foundation in the principles and applications of commerce, equipping them with the necessary knowledge and skills to embark on a successful career in the field of accounting, banking, finance, marketing, or related business disciplines.</p>
                          </div>
                        </div>
                      </div>
                    </div>
