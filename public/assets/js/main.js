...
(function($) {
    ...
    // Mobile Menu Js - Handled separately in Next.js layout to avoid race conditions
    ...
    function verticalTestimonialSlider() {
        ...
        if (verticalTestimonialSlider8) {
            verticalTestimonialSlider8 && verticalTestimonialSlider8.destroy(true, true);
        }
    ...
    function tjBaackTopController() {
        ...
        if (scrollElementWrap && scrollElementWrap.length) {
        ...
        function initStickyAndProgress() {
            mediaMatch.add("(min-width: 0)", () => {
                ...
                if ($(".tj-progress-item").length > 0) {
                    ...
                    if (tjProgressWrapper && tjProgressWrapper.children && tjProgressWrapper.children.length) {
    ...
    function initScrollProgress() {
        ...
        if (progressCircle && progressNumber) {
            ...
            function updateProgress() {
                ...
                progressNumber.textContent = Math.round(scrollPercent);
            }
    ...
    initScrollProgress();
        ...
        function initArrangeAnim() {
            ...
            if (panelsContainers && panelsContainers.length) {
                mediaMatch.add("(min-width: 992px)", () => {
        ...
        allHoverItems.forEach((hoverItem, idx) => {
            hoverItem.addEventListener("mouseenter", function() {
                allHoverItems.forEach((hoverItem2, idx) => {
                    hoverItem2 && hoverItem2.classList && hoverItem2.classList.remove("active");
                });
                this && this.classList && this.classList.add("active");
            });
        });
    }
    ...
    if (tjSliderImages && tjSliderImages.length) {
        let index = 0;
    ...
    // Portfolio Filter Js
    if ($(".portfolio-filter-box") && $(".portfolio-filter-box").length) {
